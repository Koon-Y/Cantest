...
{
  mcp2515_clearTX0_Interrupts(mcp2515_handle);
  mcp2515_clearTX1_Interrupts(mcp2515_handle);
  mcp2515_clearTX2_Interrupts(mcp2515_handle);
  // modifyRegister(mcp2515_handle, MCP_CANINTF, (CANINTF_TX0IF | CANINTF_TX1IF | CANINTF_TX2IF), 0);
}

void mcp2515_clearTX0_Interrupts(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_TX0IF, 0);
}

void mcp2515_clearTX1_Interrupts(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_TX1IF, 0);
}

void mcp2515_clearTX2_Interrupts(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_TX2IF, 0);
}
...
void mcp2515_clearWAKIF_Interrupt(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_WAKIF, 0);
}
...
void mcp2515_clear_ALL_RXNIF_Interrupt(const mcp2515_handle_t* mcp2515_handle)
{
  mcp2515_clearRX0IF_Interrupt(mcp2515_handle);
  mcp2515_clearRX1IF_Interrupt(mcp2515_handle);
}


void mcp2515_clearRX0IF_Interrupt(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_RX0IF, 0);
}

void mcp2515_clearRX1IF_Interrupt(const mcp2515_handle_t* mcp2515_handle)
{
  modifyRegister(mcp2515_handle, MCP_CANINTF, CANINTF_RX1IF, 0);
}
